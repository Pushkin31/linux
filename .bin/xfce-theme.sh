...
PREF_LIGHT_ICO="Reversal-purple"

sublime_theme_light="gruvbox"
sublime_colorscheme_light="Packages\\/User\\/Boxy Yesterday.tmTheme"
# preferences for dark theme mode
PREF_DARK_THEME="Dracula-slim-standard-buttons"
PREF_DARK_DECO="Dracula-slim-standard-buttons"
#PREF_DARK_BG="$HOME/.wall/Crow.png"
PREF_DARK_ICO="Reversal-purple-dark"
