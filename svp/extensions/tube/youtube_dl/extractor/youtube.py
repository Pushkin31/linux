...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _VALID_URL = r"""(?x)^
                     (
                         ...
                         |(?:www\.)?youtube\.com/attribution_link\?a=[^&]+&u=/watch%%3[fF]v%%3[dD]  #!SVP
                         )
    ...
    def _real_extract(self, url):
        ...
        if 'conn' in video_info and video_info['conn'][0].startswith('rtmp'):
            ...
            #!SVP #    raise ExtractorError('rtmpe downloads are not supported, see https://github.com/ytdl-org/youtube-dl/issues/343 for more information.', expected=True)
            formats = []
            formats_spec = {}
            ...
            for fmt in streaming_formats:
                ...
                more_fields = {
                    ...
                    'stereo': int_or_none(url_data.get('stereo_layout', [None])[0]), #!SVP #
                }
        ...
        #!SVP #else:
        #!SVP #    self._downloader.report_warning('unable to extract uploader nickname')
